...
public class MembershipDuesCalculator {
	 ...
	 * @param marketCode
	 */
	public BaseMembershipDues CalculateBaseDues(String zipCode, int associateCount, String marketCode, String[] coverageLevels){
		...
		try {
			...
			MembershipServiceBP bp = (MembershipServiceBP) BPF.get(User.getGenericUser(), MembershipServiceBP.class);
			baseDues = bp.CalculateBaseDues(zipCode, associateCount, marketCode, coverageLevels);
