<%@ Page Title="" Language="C#" MasterPageFile="~/Setup.master" AutoEventWireup="true" CodeFile="typeListSort.aspx.cs" Inherits="typeListSort" %>
<%@ Import Namespace="GM" %>
        ...
        <td colspan="6">
            <div class="demo-container size-thin">
                <telerik:RadListBox RenderMode="Lightweight" runat="server" ID="RadListBox1" AllowReorder="true" AllowDelete="false" 
                    ...
                    DataValueField="TaskType" 
                    DataSortField="TaskTypeOrder"
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="Select [TaskType], [TaskName] from grp_TaskType order by [TaskTypeOrder], [TaskName]"
                    UpdateCommand="UPDATE grp_TaskType SET [TaskTypeOrder] = @TaskTypeOrder WHERE [TaskType] = @TaskType">
                    <UpdateParameters>
                        <asp:Parameter Name="TaskTypeOrder" Type="Int32"></asp:Parameter>
                        <asp:Parameter Name="TaskType" Type="Int32"></asp:Parameter>
                    </UpdateParameters>
                </asp:SqlDataSource>
            </div>
        </td>
