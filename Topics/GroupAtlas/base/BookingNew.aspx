...
<script language="C#" runat="server">
    ...
    void Page_Load(object sender, System.EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Lookup.FillDropDown(agentflexid, PickList.GetTravelAgent(0), "", " ");
            Lookup.FillDropDown(state, PickList.GetState(), "", " ");
            Lookup.FillDropDown(gender, PickList.GetGender(), "", " ");
            Lookup.FillDropDown(state2, PickList.GetState(), "", " ");
            Lookup.FillDropDown(gender2, PickList.GetGender(), "", " ");
            Lookup.FillDropDown(state3, PickList.GetState(), "", " ");
            Lookup.FillDropDown(gender3, PickList.GetGender(), "", " ");
            Lookup.FillDropDown(state4, PickList.GetState(), "", " ");
            Lookup.FillDropDown(gender4, PickList.GetGender(), "", " ");
            string strDate = (g.DepartDate == g.ReturnDate) ? g.DepartDate : string.Format("{0} to {1}", g.DepartDate, g.ReturnDate);
            hdr.InnerHtml = string.Format("New Booking: {0} - {1} &nbsp;&nbsp;&nbsp;[{2}]", g.GroupID, g.GroupName, strDate);
        }
        // Custom Fields - Questions
        List<Question> queslist = Question.GetPaxQuestions(0, revtype, groupid);
    ...
    protected void BookingWizard_FinishButtonClick(object sender, WizardNavigationEventArgs e)
    {
        ...
        int bookingid = GroupBooking.Add(b);
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
	...
	<table cellpadding="0" cellspacing="0" width="100%">
        <tr><td>&nbsp;</td></tr>
		<tr>
			<td class="hdr" id="hdr" runat="server" valign="top">New Booking</td>
			<td align="right">&nbsp;
            </td>
		</tr>
		<tr>
    ...
    <asp:Wizard ID="BookingWizard" runat="server" ActiveStepIndex="0" BackColor="#EFF3FB"  
        ...
        <SideBarButtonStyle BackColor="#507CD1" Font-Names="Verdana" ForeColor="Black" Height="25px" />
        <SideBarStyle BackColor="#336699" Font-Size="0.9em" VerticalAlign="Top" Width="150px" />
        ...
        <SideBarTemplate>
    	    <asp:DataList ID="SideBarList" runat="server">
    		    ...
    		    <SelectedItemTemplate>
                    <asp:LinkButton ID="SideBarButton" runat="server" Enabled="false" Font-Bold="true" BackColor="#990000" Width="125px" />
    		    </SelectedItemTemplate>
    	    </asp:DataList>
        </SideBarTemplate>
            ...
            <asp:WizardStep ID="stepPackage" runat="server" title="Package / Options"  StepType="Start">
                ...
                <table cellpadding="3" cellspacing="1">
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <asp:DropDownList ID="paxcnt" runat="server" Width="100px" 
                                OnSelectedIndexChanged="paxcnt_SelectedIndexChanged" AutoPostBack="True">
                ...
                <tr valign="top">
                    <td>
	                    <table cellspacing="0" cellpadding="3" border="0">
                            ...
                            <tr>
                                <td width="125" class="tdlabel">Middle Name:&nbsp;</td>
                                <td><asp:textbox id="middleName" runat="server" Width="250px"  MaxLength="50"></asp:textbox></td>
                            </tr>
                            <tr>
                ...
                <tr valign="top">
                    <td>
	                    <table cellspacing="0" cellpadding="3" border="0">
                            ...
                            <tr>
                                <td width="125" class="tdlabel">Middle Name:&nbsp;</td>
                                <td><asp:textbox id="middleName2" runat="server" Width="250px"  MaxLength="50"></asp:textbox></td>
                            </tr>
                            <tr>
                                <td class="tdlabel">Last Name:&nbsp;<span class="required">*</span></td>
                ...
                <tr valign="top">
                    <td>
	                    <table cellspacing="0" cellpadding="3" border="0">
                            ...
                            <tr>
                                <td width="125" class="tdlabel">Middle Name:&nbsp;</td>
                                <td><asp:textbox id="middleName3" runat="server" Width="250px"  MaxLength="50"></asp:textbox></td>
                            </tr>
                            <tr>
                                <td class="tdlabel">Last Name:&nbsp;<span class="required">*</span></td>
                ...
                <tr valign="top">
                    <td>
	                    <table cellspacing="0" cellpadding="3" border="0">
                            ...
                            <tr>
                                <td width="125" class="tdlabel">Middle Name:&nbsp;</td>
                                <td><asp:textbox id="middleName4" runat="server" Width="250px"  MaxLength="50"></asp:textbox></td>
                            </tr>
                            <tr>
                                <td class="tdlabel">Last Name:&nbsp;<span class="required">*</span></td>
