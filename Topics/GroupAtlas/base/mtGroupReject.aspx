...
<script language="C#" runat="server">
    ...
    void Page_Load(object sender, System.EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            save.Attributes["onclick"] = string.Format("javascript:return confirm('Are you sure you wish to reject group# {0}?');", groupCode);
    ...
    void Save_Click(object sender, System.EventArgs e)
    {
        ...
        try
        {
            string AgentEmail = mtGroup.GetAgentEmail(groupCode);
            mtGroup.Reject(groupCode, rejectreason.Text, AgentEmail);
            Response.Redirect("mtGroupList.aspx?msg=Group " + groupCode + " was rejected");
        }
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="server">
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr>
			<td class="hdr" id="hdr" valign="top">Reject Group# <%=groupCode%></td>
			<td align="right">&nbsp;</td>
		</tr>
		<tr>
	...
	<table cellspacing="1" cellpadding="3" border="0">
	    ...
	    <tr valign="top">
		    <td class="tdlabel">Reject Reason:</td>
		    <td>
                <%--<asp:textbox id="rejectreason" runat="server" Width="350"  MaxLength="500" TextMode="MultiLine" Rows="4"></asp:textbox>--%>
                <telerik:RadTextBox Id="rejectreason" runat="server" Width="400"  MaxLength="500" TextMode="MultiLine" Rows="4" ></telerik:RadTextBox>
                <asp:requiredfieldvalidator id="Requiredfieldvalidator4" runat="server" Display="Dynamic" CssClass="error" ControlToValidate="rejectreason" ErrorMessage="Reject reason is required">*</asp:requiredfieldvalidator>
            </td>
	    </tr>
        <tr><td>&nbsp;</td></tr>
		<tr>
			<td colspan="2" align="center">
				<asp:button id="save" runat="server" Text="Reject" OnClick="Save_Click" CssClass="button"></asp:button>&nbsp;
