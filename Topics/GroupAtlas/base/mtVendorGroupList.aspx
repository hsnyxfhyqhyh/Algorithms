...
<script language="C#" runat="server">
    ...
    {
        if (e.Exception == null)
            message.InnerHtml = "Vendor group was successfully deleted.";
        else
        {
...
<asp:Content ID="Content1" ContentPlaceHolderID="setupContent" runat="server">
    <table cellspacing="0" cellpadding="0" width="100%">
        <tr>
            <td class="hdr" valign="bottom">Vendor Group Codes</td>
            <td align="right">
                &nbsp;&nbsp;<input type="button" onclick="javascript:window.location.href='mtVendorGroupEdit.aspx?vendorgroupcode=';return false;" value="Add Vendor Group Code" />
             </td>
        </tr>
        <tr>
    ...
    <asp:GridView ID="Grid" runat="server" Width="100%" CssClass="list" CellPadding="3" PageSize="100" GridLines="Horizontal" AllowPaging="true" AllowSorting="true" DataSourceID="gridSource"
        AutoGenerateColumns="False" DataKeyNames="vendorgroupcode" onrowdeleted="Grid_RowDeleted">
        <HeaderStyle CssClass="listhdr" />
        <Columns>
	        <asp:HyperLinkField DataTextField="vendorgroupcode" HeaderText="Vendor Group Code" HeaderStyle-HorizontalAlign="Left" SortExpression="vendorgroupcode" DataNavigateUrlFormatString="mtVendorGroupEdit.aspx?vendorgroupcode={0}" DataNavigateUrlFields="vendorgroupcode" />  
    ...
    <asp:ObjectDataSource ID="gridSource" runat="server" SelectMethod="GetList" DeleteMethod="Delete" TypeName="GM.mtVendorGroup" />
</asp:Content>
